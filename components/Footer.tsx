    ...
    >
      ...
      <div className="container" style={{ position: 'relative', zIndex: 1 }}>
        ...
        >
          ...
          >
            <Link href="/privacidade" className="foot-link" style={{ color: '#333', fontSize: 10, letterSpacing: '.2em', textTransform: 'uppercase', fontFamily: 'var(--mono)' }}>Política de Privacidade</Link>
            {' · '}
            <Link href="/termos" className="foot-link" style={{ color: '#333', fontSize: 10, letterSpacing: '.2em', textTransform: 'uppercase', fontFamily: 'var(--mono)' }}>Termos e Condições</Link>
            {' · '}
            <Link href="/cookies" className="foot-link" style={{ color: '#333', fontSize: 10, letterSpacing: '.2em', textTransform: 'uppercase', fontFamily: 'var(--mono)' }}>Política de Cookies</Link>
          </div>
        </div>
      </div>
